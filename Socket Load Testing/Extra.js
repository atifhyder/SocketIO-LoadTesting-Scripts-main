...
const createClient = () => {
    ...
    //     logger.warn(`Match Event - username ${userName}  - ${matchEvenet}`)
    //     console.warn(`Match Event - username ${userName}  - ${matchEvenet}`)
    // });
